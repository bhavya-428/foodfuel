...
const menuItems = [
  ...
  { id: 61, name: 'Chocolate Banana Smoothie', type: 'Smoothies', price: '$5.89', img: 'https://sonshinekitchen.com/wp-content/uploads/2018/03/chocolate-banana-milkshake-10.jpg' },
...
export const seedMenu = async () => {
  const querySnapshot = await getDocs(query(collection(db, 'menuItems'), limit(1)));
  ...
  const promises = menuItems.map(item => addDoc(collection(db, 'menuItems'), item));
  try {
