...
function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.warn("Error saving order to Firestore. Saving to localStorage fallback:", error);
      const existingLocalOrders = JSON.parse(localStorage.getItem('localOrders') || '[]');
      existingLocalOrders.push({
        ...orderData,
        id: orderId
      });
      localStorage.setItem('localOrders', JSON.stringify(existingLocalOrders));
    } finally {
